package com.cyancaesar.humanmod.client.utils;
...
public class FollowGoal extends Goal {
    private static final EntityPredicate TEMP_TARGETING = (new EntityPredicate()).range(200.0D).allowInvulnerable().allowSameTeam().allowNonAttackable().allowUnseeable();
    ...
    public FollowGoal(CreatureEntity p_i47822_1_, double p_i47822_2_, Ingredient p_i47822_4_, boolean p_i47822_5_) {
        this(p_i47822_1_, p_i47822_2_, p_i47822_5_, p_i47822_4_);
    }

    public FollowGoal(CreatureEntity p_i47823_1_, double p_i47823_2_, boolean p_i47823_4_, Ingredient p_i47823_5_) {
