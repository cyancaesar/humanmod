package com.cyancaesar.humanmod.common.containers;
...
public class HumanContainer extends Container {
    private final TileEntity tileEntity;
    private final PlayerEntity playerEntity;
    private final IItemHandler playerInv;

    public HumanContainer(int windowsId, World world, BlockPos blockPos, PlayerInventory playerInventory, PlayerEntity player) {
        super(ContainerTypeInit.HUMAN_CONTAINER.get(), windowsId);
    ...
    public boolean stillValid(PlayerEntity player) {
        return stillValid(IWorldPosCallable.create(tileEntity.getLevel(), tileEntity.getBlockPos()), player, BlockInit.HUMAN_BLOCK.get());
    }
